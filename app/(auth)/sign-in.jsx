      ...
      <ScrollView>
        <View
          ...
          <View>
            <Link
              href='/'
              className='text-quaternary font-pbold text-3xl  mb-6 text-start ' >ToDoList</Link>

          </View>
          <Text
            className="text-2xl text-senary font-psemibold text-start mb-2">Log In</Text>
          {/* <Image 
          ...
          <CustomButton
            ...
            title='Log In' handlePress={submit} containerStyles='bg-secondary mt-8 py-4 mb-8'>
